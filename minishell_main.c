...
/*   Updated: 2021/04/01 13:59:28 by ymarji           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void execute(t_global *m_gl, char *line)
{
	...
	tab = ft_split(line, ' ');
	// if (tab[0] && !strcmp(tab[0], "echo"))
	// 	echo_main(m_gl, tab);
	// else if (tab[0] && !strcmp(tab[0], "cd"))
	// 	cd_main(m_gl, tab);
	// else if (tab[0] && !strcmp(tab[0], "pwd"))
	// 	pwd_main(m_gl, tab);
	// // else if (tab[0] && !strcmp(tab[0], "ls"))
	// // 	ls();
	// else if (tab[0] && !strcmp(tab[0], "env"))
	// 	env_main(m_gl, tab);
	// else if (tab[0] && !strcmp(tab[0], "export"))
	// 	export_main(m_gl, tab);
	// else if (tab[0] && !strcmp(tab[0], "unset"))
	// 	unset(m_gl, tab);
	// else if (tab[0] && !strcmp(tab[0], "exit"))
	// 	exit(0);
	// i = check_built(m_gl, tab);
	// printf("%d\n", i);
